...
def scrap_bundesliga(url):
    ...
    if response.status_code == 200:
        ...
        if table:
            ...
            with open("classement_liga.csv", "w", newline="", encoding="utf-8") as csvfile:
            ...
            print("Les données ont été extraites avec succès et écrites dans le fichier classement_liga.csv.")
        else:
...
# Insertion des données du fichier CSV dans MongoDB
insert_into_mongodb("classement_liga.csv", mongodb_uri, db_name, collection_name)
