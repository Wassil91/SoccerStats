...
collection_name = "Resultats_Predits_serieA"
...
saisons = ["matchs_serieA", "matchs_serieA_22-23", "matchs_serieA_21-22", "matchs_serieA_20-21"]

# Récupérer les moyennes des statistiques offensives pour chaque équipe
stats_off = {}
for document in db["Stats_off_prevision_serieA"].find():
...
stats_def = {}
for document in db["Stats_def_prevision_serieA"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
...
stats_gen = {}
for document in db["Stats_gen_prevision_serieA"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
