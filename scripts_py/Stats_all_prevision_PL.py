...
collection_name = "Resultats_Predits_PL"
...
saisons = ["matchs_PL", "matchs_PL_22-23", "matchs_PL_20-21"]

# Récupérer les moyennes des statistiques offensives pour chaque équipe
stats_off = {}
for document in db["Stats_off_prevision_PL"].find():
...
stats_def = {}
for document in db["Stats_def_prevision_PL"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
...
stats_gen = {}
for document in db["Stats_gen_prevision_PL"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
