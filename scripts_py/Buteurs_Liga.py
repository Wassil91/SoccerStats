...
# Fonction pour se connecter à MongoDB et récupérer la base de données
    ...
    def scrape_and_store_buteurs_liga():
        # URL à scraper
        url = "https://www.maxifoot.fr/classement-buteur-liga-espagne.htm"
        ...
        if response.status_code == 200:
            ...
            print("Les données ont été extraites avec succès et stockées dans la collection 'Buteurs_Liga' de la base de données 'SoccerStats'.")
        else:
