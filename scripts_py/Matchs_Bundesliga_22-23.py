...
def store_in_mongodb(csv_file):
    ...
    db.drop_collection('matchs_bundesliga_22-23')
    # Sélectionner ou créer une collection
    collection = db['matchs_bundesliga_22-23']
...
url = "https://www.maxifoot.fr/calendrier-bundesliga-allemagne-2022-2023.htm"
