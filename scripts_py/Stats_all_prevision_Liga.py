...
collection_name = "Resultats_Predits_Liga"
...
saisons = ["matchs_Liga", "matchs_Liga_22-23", "matchs_Liga_21-22", "matchs_Liga_20-21"]

# Récupérer les moyennes des statistiques offensives pour chaque équipe
stats_off = {}
for document in db["Stats_off_prevision_Liga"].find():
...
stats_def = {}
for document in db["Stats_def_prevision_Liga"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
...
stats_gen = {}
for document in db["Stats_gen_prevision_Liga"].find():
    equipe = document["Équipe"]
    del document["_id"]
    del document["Équipe"]
