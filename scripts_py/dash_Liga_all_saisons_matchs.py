...
def calculate_summary_statistics_liga(df):
...
def dash_Liga():
    ...
    def update_graphs(selected_season):
        if selected_season == '21_22':
            ...
            df = load_data_liga("matchs_Liga")  # For current season

        goals_summary, goals_conceded_summary, goals_per_matchday = calculate_summary_statistics_liga(df)
...
if __name__ == '__main__':
    dash_Liga().run_server(debug=True)
