...
def get_data_from_mongodb():
    ...
    logos_joueur_ligue1 = {
        ...
        "G. MIKAUTADZE":"https://efootballhub.net/images/efootball23/players/134545_.png",
        "R. DEL CASTILLO": "https://www.efootballratings.com/wp-content/uploads/110648_.png"
...
def get_data_from_mongodb2():
    ...
    logos_joueur_liga = {
        ...
        "A. GRIEZMANN":"https://efootballhub.net/images/efootball23/players/105575933322572_.png"
    }
    client = pymongo.MongoClient(mongodb_uri)
    db = client[db_name]
    classement_collection = db[classement_collection_name]
...
def get_data_from_mongodb3():
    ...
    logos_joueur_serieA = {
        ...
        "H. ÇALHANOGLU":"https://imagecdn.fcupdate.nl/?url=https://staticcdn.fcupdate.nl/player-image/botfgp0oq4wqlwtcs9m90kded/transparent.png",
        "M. THURAM":"https://api.efootballdb.com/assets/2022/players/105641431639589_.png.webp"
    }
...
def get_data_from_mongodb4():
    ...
    logos_joueur_bundes = {
        ...
        "F. WIRTZ":"https://api.efootballdb.com/assets/2022/players/137924_.png.webp"
    }
...
def matches():
    ...
    last_matches = get_matchs_by_journee(29)  # Récupérer les matchs de la 26e journée
    next_matches = get_matchs_by_journee(30)  # Récupérer les matchs de la 27e journée
...
def liga():
    ...
    last_matches = get_matchs_by_journee2(31)  # Récupérer les matchs de la 26e journée
    next_matches = get_matchs_by_journee2(32)  # Récupérer les matchs de la 27e journée
...
def serieA():
    ...
    last_matches = get_matchs_by_journee3(32)  # Récupérer les matchs de la 26e journée
    next_matches = get_matchs_by_journee3(33)  # Récupérer les matchs de la 27e journée
...
def bundesliga():
    ...
    last_matches = get_matchs_by_journee4(29)  # Récupérer les matchs de la 26e journée
    next_matches = get_matchs_by_journee4(30)  # Récupérer les matchs de la 27e journée
...
def PL():
    ...
    last_matches = get_matchs_by_journee5(33)  # Récupérer les matchs de la 26e journée
    next_matches = get_matchs_by_journee5(34)  # Récupérer les matchs de la 27e journée
